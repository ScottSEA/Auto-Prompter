...
/**
 * TDD step 1: prove Room3/KSP codegen compiles and a real bundled-SQLite database opens, accepts a
 * write, reads it back, and closes -- before the full contract runs against it.
 */
class RoomDocumentStoreSmokeTest {

    @Test
    fun freshDatabaseIsEmptyThenRoundTripsOneSave() = roomStoreTest { newStore ->
        val store = newStore()
